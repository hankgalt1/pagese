...
//Функция для создания на кэнвасе объектов загрузочного экрана.
    create(){
        ...
        this.add.container(0, this.scale.height/1.05,[
            ...
            this.rectingRextLeft = this.add.rectangle(
            this.scale.width/25,
            0,
            10,
            this.scale.height/20-8 ,
            ...
            this.rectingRextRight = this.add.rectangle(
                this.scale.width-this.scale.width/20*2+this.scale.width/20,
                0,
                10,
                this.scale.height/20-8 ,
                0x37c3be),
            ...
            this.rectingRextDown = this.add.rectangle(
                this.scale.width/2,
                this.recting.height/2-2,
                this.scale.width-this.scale.width/20*2+this.scale.width/20-this.scale.width/25+10-4,
                5 ,
                0x37c3be),

            this.rectingRextUp = this.add.rectangle(
                this.scale.width/2,
                -this.scale.width/25+4,
                this.scale.width-this.scale.width/20*2+this.scale.width/20-this.scale.width/25+10-4,
                5 ,
                0x37c3be),
